...
import com.example.myapplication2.databinding.FragmentHealthBinding;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        backgroundImage.setImageResource(R.drawable.backgroundimagefour);

        String videoPath1 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.grocerythree;
        String videoPath2 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.groceryone;
        String videoPath3 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.grocerytwo;
