...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        backgroundImage.setImageResource(R.drawable.backgroundimagetwo);

        String videoPath1 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.rocksone;
        String videoPath2 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.rockstwo;
        String videoPath3 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.rocksthree;
