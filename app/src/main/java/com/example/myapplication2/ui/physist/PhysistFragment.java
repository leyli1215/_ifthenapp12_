...
import com.example.myapplication2.databinding.FragmentPhysistsBinding;
import com.example.myapplication2.databinding.FragmentRocketBinding;

public class PhysistFragment extends Fragment {

    private FragmentPhysistsBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View rootView = inflater.inflate(R.layout.fragment_physists, container, false);
        ...
        backgroundImage.setImageResource(R.drawable.backgroundimageseven);

        String videoPath1 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.scienceone;
        String videoPath2 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.sciencetwo;
        String videoPath3 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.sciencethree;
        ...
        bigPause1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                videoView1.pause();
        ...
        bigFullscreen1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        bigPause2.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                videoView2.pause();
        ...
        bigFullscreen2.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        fullscreenButton2.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        bigPause3.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                videoView3.pause();
                videoView1.setVisibility(videoView1.VISIBLE);
        ...
        bigFullscreen3.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        fullscreenButton3.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
