...
public class healthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        backgroundImage.setImageResource(R.drawable.backgroundimagefive);

        String videoPath1 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.healthone;
        String videoPath2 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.healthtwo;
        String videoPath3 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.lifethree;
