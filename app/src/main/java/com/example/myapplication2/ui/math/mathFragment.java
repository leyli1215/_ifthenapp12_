...
public class mathFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        backgroundImage.setImageResource(R.drawable.backgroundimagesix);

        String videoPath1 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.mathone;
        String videoPath2 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.mathtwo;
        String videoPath3 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.maththree;
