...
import com.example.myapplication2.databinding.FragmentMathBinding;
import com.example.myapplication2.databinding.FragmentScienceBinding;
import com.example.myapplication2.ui.gallery.GalleryViewModel;
...
public class  scienceFragment  extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        backgroundImage.setImageResource(R.drawable.backgroundimagethree);

        String videoPath1 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.consfour;
        String videoPath2 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.consone;
        String videoPath3 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.constwo;
