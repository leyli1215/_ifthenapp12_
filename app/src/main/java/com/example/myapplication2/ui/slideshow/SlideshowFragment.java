...
public class SlideshowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        backgroundImage.setImageResource(R.drawable.backgroundimageone);

        String videoPath1 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.lifeone;
        String videoPath2 = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.lifetwo;
